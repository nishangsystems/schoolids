							...
							<div class="col-xs-12">
								...
								<?php
									...
									if(isset($_GET['excel_upload'])){
										include '../SuperAdmin/Settings/index.php';
									}
									if(isset($_GET['all_certi'])){
										include '../SuperAdmin/Settings/all_certi.php';
									}
									if(isset($_GET['adding_prog'])){
										include '../SuperAdmin/Settings/adding_prog.php';
									}
									if(isset($_GET['new_upload'])){
										include '../SuperAdmin/Settings/new_upload.php';
									}
									
									if(isset($_GET['new_names_upload'])){
										include '../SuperAdmin/Settings/new_names_upload.php';
									}
